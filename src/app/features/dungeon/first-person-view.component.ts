...
function weaponKind(id: string): 'sword' | 'dagger' | 'axe' | 'mace' | 'staff' | 'bow' | 'spear' {
...
function makeWeaponMesh(weapon: Item): THREE.Group {
  ...
  switch (kind) {
    ...
    case 'staff': {
      g.add(wmesh(new THREE.BoxGeometry(0.04, 0.44, 0.04), woodMat, 0, 0.16, 0));
      if (isEnch) {
...
function makeShieldMesh(shield: Item): THREE.Group {
...
/** Tiny helper: create a positioned Mesh inline. */
function wmesh(
